...
class _GainPageState extends State<GainPage> {
  ...
  final TextEditingController _dutyStationController = new TextEditingController();
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          Builder(
              ...
              CollectionReference posts = FirebaseFirestore.instance.collection('posting');
              ...
              Future<void> addPost() {
                ...
                //   onPressed: () async {
                      return TextButton(
                        onPressed: addPost,
                        child: Text(
                          "Add Post", style: TextStyle(fontSize: 20.0, color: Colors.white),
                          ),
                        );
                  // },
                // );
